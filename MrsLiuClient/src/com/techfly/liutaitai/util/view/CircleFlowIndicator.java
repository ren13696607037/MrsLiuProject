...
public class CircleFlowIndicator extends View implements FlowIndicator, AnimationListener {
    ...
    public CircleFlowIndicator(Context context, AttributeSet attrs) {
        ...
        // Retrieve the radius
        radius = a.getDimension(R.styleable.CircleFlowIndicator_radius, 0f);

        // Retrieve the spacing
        spacing = a.getDimension(R.styleable.CircleFlowIndicator_spacing, 0f);
    ...
    private void initColors(int activeColor, int inactiveColor, int activeType, int inactiveType) {
        ...
        default:
            ...
            mPaintInactive.setStrokeWidth(1);
    ...
    public void onScrollFinished() {
    	...
    	SharePreferenceUtils.getInstance(mContext).saveIsFirst(false);
