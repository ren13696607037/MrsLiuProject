...
public class PhotoCropActivity extends PhotoBaseActivity implements View.OnClickListener{
    ...
    public static final String PHOTO_CROP_MODE = "photo_crop_mode";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCropMode = (CropMode) getIntent().getSerializableExtra(PHOTO_CROP_MODE);
        ...
        mIvPhoto.setCropMode(mCropMode);
    ...
    public void onClick(View v) {
        ...
        if ( id == R.id.fab_ok ) {
            ...
            intent.putExtra(GalleryHelper.APPLY_TYPE, mType);
