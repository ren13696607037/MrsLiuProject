...
public class AddManageAdapter extends BaseAdapter {
    ...
    public AddManageAdapter(Context context,ArrayList<AddressManage> list,AddressManageFragment fragment){
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if(arg1==null){
            ...
            arg1=LayoutInflater.from(mContext).inflate(R.layout.item_address, null);
        ...
        if(!TextUtils.isEmpty(mList.get(arg0).getmCity())&&!"null".equals(mList.get(arg0).getmCity())){
        	holder.mTvAdd.setText(mContext.getString(R.string.address_text,mList.get(arg0).getmCity()));
        }
        if(!TextUtils.isEmpty(mList.get(arg0).getmCircle())&&!"null".equals(mList.get(arg0).getmCircle())){
        	address=holder.mTvAdd.getText().toString();
        	if(address.length()==0){
        		holder.mTvAdd.setText(mContext.getString(R.string.address_text,mList.get(arg0).getmCircle()));
        	}else{
        		holder.mTvAdd.setText(address+"/"+mList.get(arg0).getmCircle());
        	}
    		if(!TextUtils.isEmpty(mList.get(arg0).getmDetail())&&!"null".equals(mList.get(arg0).getmDetail())){
    			address=holder.mTvAdd.getText().toString();
        ...
        holder.mTvChange.setOnClickListener(new AddManageClick(mContext, mList.get(arg0).getmId()+"", "",this,mFragment,mList.get(arg0)));
        holder.mTvDelete.setOnClickListener(new AddManageClick(mContext, mList.get(arg0).getmId()+"", mList.get(arg0).isDefault()+"",this,mFragment,mList.get(arg0)));
        holder.mIvSelect.setBackgroundResource(mList.get(arg0).isDefault()?R.drawable.address_default:R.drawable.address_undefault);
        return arg1;
    }
    class ViewHolder{
