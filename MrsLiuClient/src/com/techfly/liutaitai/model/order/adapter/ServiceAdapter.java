...
public class ServiceAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.mButton.setOnClickListener(new ServiceClick(mContext, holder.mButton.getText().toString(), mList.get(position),0));
		holder.mButton2.setOnClickListener(new ServiceClick(mContext, holder.mButton2.getText().toString(), mList.get(position),0));
		return convertView;
	}
