...
public class NewProductInfoParser implements Parser {
        ...
        if (object != null) {
            ...
            if (resultCode == 0) {
                ...
                if (jsonObject != null) {
                    ...
                    for (int i = 0; i < p.getmImgArray().size(); i++) {
                        ImageEntity entity = new ImageEntity();
                        entity.setImagePath(p.getmImgArray().get(i));
                        list.add(entity);
                    }
                    p.setmImageEntity(list);
        ...
        if (jsonArray != null) {
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (mJsonObject != null) {
                    ...
                    c.setmTime(mJsonObject.optString("time"));
                    c.setmTitle(mJsonObject.optString("content"));
    ...
    private List<String> parseImages(JSONObject jsonObject) {
        String str = jsonObject.optString("imgs");
        JSONObject obj = null;
