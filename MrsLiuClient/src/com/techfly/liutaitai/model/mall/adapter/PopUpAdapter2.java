...
//        slide_bottom_to_top=AnimationUtils.loadAnimation(context, R.anim.slide_bottom_to_top);  
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_popupwindow2, null);
...
//        convertView.setAnimation(slide_bottom_to_top); 
        ...
        if(mItemList.get(position).ismIsSelect()){
            convertView.setBackgroundResource(R.drawable.service_cate2);
        }else{
            convertView.setBackgroundResource(R.drawable.service_cate1);
        }
