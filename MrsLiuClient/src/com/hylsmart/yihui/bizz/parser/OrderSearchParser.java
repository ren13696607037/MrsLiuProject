...
public class OrderSearchParser implements Parser {
    ...
    public Object fromJson(JSONObject object) {
        ...
        if(array!=null&&array.length()>0){
        	...
        	logistics.setmReason(reason.optString(JsonKey.OrderSearchKey.REASON));
        }
        ...
        if(resultCode==0){
        		if(array!=null){
        			...
        			for(int i=0;i<size;i++){
        				...
        				suggest.setmMessage(data.optString(JsonKey.OrderSearchKey.REMARK));
        				suggest.setmTime(data.optString(JsonKey.OrderSearchKey.TIME));
        				suggest.setmContent(data.optString(JsonKey.OrderSearchKey.ZONE));
        				list.add(suggest);
        			}
